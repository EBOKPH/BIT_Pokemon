...
function navbarBlurOnScroll(n) {
  if ("true" === document.getElementById(n).getAttribute("data-scroll")) {
    let e = document.getElementById(n);
    var a,
      n = !!e && e.getAttribute("data-scroll");
    let t = ["blur", "shadow-blur", "left-auto"],
      s = ["shadow-none"];
    function i() {
      e.classList.add(...t), e.classList.remove(...s), l("blur");
    }
    function r() {
      e.classList.remove(...t), e.classList.add(...s), l("transparent");
    }
    function l(e) {
...
function darkMode(e) {
  ...
  if (e.getAttribute("checked")) {
    ...
    for (L = 0; L < s.length; L++)
      s[L].classList.contains("light") &&
        (s[L].classList.add("dark"), s[L].classList.remove("light"));
    for (L = 0; L < n.length; L++)
      n[L].classList.contains("light") &&
        (n[L].classList.add("dark"), n[L].classList.remove("light"));
    for (L = 0; L < a.length; L++)
      a[L].classList.contains("text-white") &&
        (a[L].classList.remove("text-white"), a[L].classList.add("text-dark"));
    for (L = 0; L < r.length; L++)
      !r[L].classList.contains("text-white") ||
        r[L].closest(".sidenav") ||
        r[L].closest(".card.bg-gradient-dark") ||
        (r[L].classList.remove("text-white"), r[L].classList.add("text-dark"));
    for (L = 0; L < o.length; L++)
      o[L].classList.contains("text-white") &&
        (o[L].classList.remove("text-white"), o[L].classList.add("text-dark"));
    for (L = 0; L < d.length; L++)
      d[L].classList.contains("text-white") &&
        !d[L].closest(".sidenav") &&
        (d[L].classList.remove("text-white"), d[L].classList.add("text-dark"));
    for (L = 0; L < u.length; L++)
      u[L].classList.contains("text-white") &&
        (u[L].classList.remove("text-white"),
        u[L].classList.remove("opacity-8"),
        u[L].classList.add("text-dark"));
    for (L = 0; L < v.length; L++)
      v[L].classList.contains("bg-gray-600") &&
        (v[L].classList.remove("bg-gray-600"),
        v[L].classList.add("bg-gray-100"));
    for (L = 0; L < y.length; L++)
      y[L].hasAttribute("fill") && y[L].setAttribute("fill", "#252f40");
    for (L = 0; L < m.length; L++)
      m[L].closest(".card.bg-gradient-dark") ||
        (m[L].classList.remove("text-white"), m[L].classList.add("text-dark"));
    for (L = 0; L < b.length; L++) b[L].classList.remove("border-dark");
    e.removeAttribute("checked");
  } else {
    t.classList.add("dark-version");
    for (var L = 0; L < s.length; L++)
      s[L].classList.contains("dark") &&
        (s[L].classList.remove("dark"), s[L].classList.add("light"));
    for (var L = 0; L < n.length; L++)
      n[L].classList.contains("dark") &&
        (n[L].classList.remove("dark"), n[L].classList.add("light"));
    for (var L = 0; L < a.length; L++)
      a[L].classList.contains("text-dark") &&
        (a[L].classList.remove("text-dark"), a[L].classList.add("text-white"));
    for (var L = 0; L < i.length; L++)
      i[L].classList.contains("text-dark") &&
        (i[L].classList.remove("text-dark"), i[L].classList.add("text-white"));
    for (var L = 0; L < l.length; L++)
      l[L].classList.contains("text-dark") &&
        (l[L].classList.remove("text-dark"), l[L].classList.add("text-white"));
    for (var L = 0; L < c.length; L++)
      c[L].classList.contains("text-dark") &&
        (c[L].classList.remove("text-dark"), c[L].classList.add("text-white"));
    for (var L = 0; L < u.length; L++)
      u[L].classList.contains("text-secondary") &&
        (u[L].classList.remove("text-secondary"),
        u[L].classList.add("text-white"),
        u[L].classList.add("opacity-8"));
    for (var L = 0; L < f.length; L++)
      f[L].classList.contains("bg-gray-100") &&
        (f[L].classList.remove("bg-gray-100"),
        f[L].classList.add("bg-gray-600"));
    for (var L = 0; L < g.length; L++)
      g[L].classList.remove("text-dark"), g[L].classList.add("text-white");
    for (var L = 0; L < y.length; L++)
      y[L].hasAttribute("fill") && y[L].setAttribute("fill", "#fff");
